...
urlpatterns = [
	...
	url(r'^stop/add/$',views.StopCreate.as_view(), name = "stop_create"),
	url(r'^bus/add/$',views.BusCreate.as_view(), name = "bus_create"),
	url(r'^request/add/$',views.CoordRequestCreate.as_view(), name = "request_create"),
	url(r'^reporter/add/$',views.ReporterCreate.as_view(), name = "reporter_create"),
	...
	url(r'^reporter/update/(?P<pk>[0-9]+)/$',views.ReporterUpdate.as_view(), name = "reporter_update"),
