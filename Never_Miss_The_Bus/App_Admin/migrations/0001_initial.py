# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-05-12 11:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bus_name', models.CharField(max_length=30, unique=True, verbose_name='Bus Name')),
        ...
        migrations.AddField(
            model_name='bus',
            name='route',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_Admin.Route', verbose_name='Route'),
        ),
    ]
