...
(function() {
    ...
    google.maps.Load = function(apiLoad) {
        ...
        apiLoad([0.009999999776482582, [
                ...
                [
                    ["https://khms0.googleapis.com/kh?v=200\u0026hl=en-US\u0026", "https://khms1.googleapis.com/kh?v=200\u0026hl=en-US\u0026"], null, null, null, 1, "200", ["https://khms0.google.com/kh?v=200\u0026hl=en-US\u0026", "https://khms1.google.com/kh?v=200\u0026hl=en-US\u0026"]
                ], null, [
            ...
            [2403837112], 1, null, null, null, null, null, "", null, null, 1, "https://khms.googleapis.com/mz?v=200\u0026", null, "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [
...
(function(_) {
    ...
    te = function() {
        ...
        7 == this.type && (b = /^Mozilla\/.*Gecko\/.*[Minefield|Shiretoko][ /]?([0-9]+).?([0-9]+)?/, d = b.exec(this.V)) && (this.type = 5, this.version = new qe((0, window.parseInt)(d[1], 10), (0, window.parseInt)(d[2] || "0", 10)));
        ...
        4 == this.j && (b = /Android (\d+)\.?(\d+)?/.exec(this.V)) && (this.U = new qe((0, window.parseInt)(b[1], 10), (0, window.parseInt)(b[2] || "0", 10)));
    ...
    Fg = function(a, b) {
        ...
        _.W && +qf() && (h = !1);
        h && (g = new og(a, _.Cg, _.Gf(), new _.bd(null)), _.J.forward(g, "staticmaploaded", this), g.set("size", f), g.bindTo("center", this), g.bindTo("zoom", this), g.bindTo("mapTypeId", this), g.bindTo("styles", this), g.bindTo("mapMaker", this));
